...
function DevHome() {
  const [playerState, setPlayerState] = useState<PlayerState>({
    ...
    available_upgrades: [
      ...
      { id: 6, name: "Пул хешей", description: "Объединённый хеш-рейт фермы усиливает доход в секунду.", upgrade_type: "income_multiplier", value: 1.5, base_price: 25000, min_total_taps: 5000, icon_name: "⛏️" },
      ...
      { id: 8, name: "Удлинённая смена", description: "Оффлайн-накопление ещё на 1 час (поверх базового лимита).", upgrade_type: "offline_extension", value: 60, base_price: 5000, min_total_taps: 0, icon_name: "⏱️" },
      ...
      { id: 10, name: "12-часовой буфер", description: "До 12 часов пассивного дохода без входа в игру.", upgrade_type: "offline_extension", value: 360, base_price: 500000, min_total_taps: 25000, icon_name: "🗄️" },
      { id: 11, name: "Мемпул-буст", description: "Транзакции в очереди ускоряют силу каждого клика.", upgrade_type: "click_multiplier", value: 1.8, base_price: 1500000, min_total_taps: 250000, icon_name: "📨" },
      { id: 12, name: "Квантовый тап", description: "Суперпозиция кликов: каждый тап бьёт сразу по нескольким nonce.", upgrade_type: "click_multiplier", value: 2.5, base_price: 5000000, min_total_taps: 500000, icon_name: "⚛️" },
      { id: 13, name: "GPU-оверклок", description: "Разгон видеокарт без перегрева — +75% к пассивному доходу.", upgrade_type: "income_multiplier", value: 1.75, base_price: 1000000, min_total_taps: 100000, icon_name: "🎮" },
      { id: 14, name: "Суперкомпьютер ×3", description: "Кластер ASIC на полную: пассивный доход утраивается.", upgrade_type: "income_multiplier", value: 3, base_price: 5000000, min_total_taps: 500000, icon_name: "🧠" },
      { id: 15, name: "Суточный резерв", description: "Холодное хранение прогресса: ещё 24 часа оффлайн-накопления.", upgrade_type: "offline_extension", value: 1440, base_price: 2000000, min_total_taps: 100000, icon_name: "🧊" },
    ],
